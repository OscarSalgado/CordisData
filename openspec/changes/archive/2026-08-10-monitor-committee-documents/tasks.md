...
- [x] Add unit tests for CommitteeDocumentsFetcher
...
- [x] Create config file management module `src/cordis_data/data/committees/config.py`
...
- [x] Add unit tests for config management
  - Test load/save operations
  - Test validation logic
  - Test default creation

### CLI (3 tasks)
- [x] Create `src/cordis_data/cli/monitor.py` with Click command group
...
- [x] Register monitor CLI group with main CLI
...
- [x] Create initial unit test suite
  - Mock API responses
...
- [x] Create `src/cordis_data/data/committees/alerts.py`
...
- [x] Implement Slack notifications for NEW documents
...
- [x] Implement GitHub Issues integration for NEW documents
...
- [x] Add unit tests for alert senders
  - Mock HTTP requests
...
- [x] Create `.github/workflows/monitor-committees.yml`
...
- [x] Add workflow secrets configuration docs
  - Document required secrets: `CORDIS_SLACK_WEBHOOK`, `GH_TOKEN`
  - Provide setup instructions

- [x] Add GitHub Actions integration tests
  - Test workflow trigger
  - Test commit logic (only on changes)

### User Documentation (1 task)
- [x] Write user guide: `docs/committee-monitoring.md`
...
- [x] Add GitHub Actions workflow tests
  - Dry-run workflow
